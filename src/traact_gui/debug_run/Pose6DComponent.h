...
#ifndef TRAACT_GUI_SRC_TRAACT_GUI_DEBUG_RUN_POSE6DCOMPONENT_H_
#define TRAACT_GUI_SRC_TRAACT_GUI_DEBUG_RUN_POSE6DCOMPONENT_H_
...
#endif //TRAACT_GUI_SRC_TRAACT_GUI_DEBUG_RUN_POSE6DCOMPONENT_H_
