...
#ifndef TRAACT_GUI_SRC_TRAACT_APPLICATION_DATA_SOURCE_RAWSOURCE_H_
#define TRAACT_GUI_SRC_TRAACT_APPLICATION_DATA_SOURCE_RAWSOURCE_H_
...
#endif //TRAACT_GUI_SRC_TRAACT_APPLICATION_DATA_SOURCE_RAWSOURCE_H_
