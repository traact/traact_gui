...
#ifndef TRAACT_GUI_SRC_TRAACT_DEBUG_RUN_DEBUGRENDERCOMPONENT_H_
#define TRAACT_GUI_SRC_TRAACT_DEBUG_RUN_DEBUGRENDERCOMPONENT_H_
...
#endif //TRAACT_GUI_SRC_TRAACT_DEBUG_RUN_DEBUGRENDERCOMPONENT_H_
