...
#ifndef TRAACT_GUI_SRC_TRAACT_DEBUG_RUN_SCENE_COMPONENT_STATICPOSE_H_
#define TRAACT_GUI_SRC_TRAACT_DEBUG_RUN_SCENE_COMPONENT_STATICPOSE_H_
...
#endif //TRAACT_GUI_SRC_TRAACT_DEBUG_RUN_SCENE_COMPONENT_STATICPOSE_H_
