...
#ifndef TRAACT_GUI_SRC_TRAACT_DEBUG_RUN_IMAGECOMPONENT_H_
#define TRAACT_GUI_SRC_TRAACT_DEBUG_RUN_IMAGECOMPONENT_H_
...
#endif //TRAACT_GUI_SRC_TRAACT_DEBUG_RUN_IMAGECOMPONENT_H_
