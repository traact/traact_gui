...
#ifndef TRAACT_GUI_SRC_TRAACT_SELECTEDTRAACTELEMENT_H_
#define TRAACT_GUI_SRC_TRAACT_SELECTEDTRAACTELEMENT_H_
...
#endif //TRAACT_GUI_SRC_TRAACT_SELECTEDTRAACTELEMENT_H_
